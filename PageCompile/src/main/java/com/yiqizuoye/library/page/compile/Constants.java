...
public class Constants {
    ...
    public static final String CLASSNAME_PAGE_RULE = "com.yiqizuoye.library.page.api.PageRuleData";
    ...
    public static final String CLASSNAME_ACTION_RULE = "com.yiqizuoye.library.page.api.ActionRuleData";
    ...
    public static final String CLASSNAME_PAGE_QUEUE = "com.yiqizuoye.library.page.api.PageQueueData";
